...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/var/www/www.webwebmaster.fr/http_docs/path/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/www.webwebmaster.fr/http_docs/path/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'backoffice', 'user' => 'root', 'password' => 'bg27tzp9e', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_ff6d75cb66918d7e42745acf41a2c6258c7814d0db27ad97d9952ea5d65ef7a9');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_ff6d75cb66918d7e42745acf41a2c6258c7814d0db27ad97d9952ea5d65ef7a9');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_ff6d75cb66918d7e42745acf41a2c6258c7814d0db27ad97d9952ea5d65ef7a9');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/var/www/www.webwebmaster.fr/http_docs/path/src/Backoffice/MenusBundle/Entity', 1 => '/var/www/www.webwebmaster.fr/http_docs/path/src/Backoffice/ContenusBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Backoffice\\MenusBundle\\Entity');
        $f->addDriver($e, 'Backoffice\\ContenusBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('BackofficeMenusBundle' => 'Backoffice\\MenusBundle\\Entity', 'BackofficeContenusBundle' => 'Backoffice\\ContenusBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/www.webwebmaster.fr/http_docs/path/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/www.webwebmaster.fr/http_docs/path/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/administrateur');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/administrateur', NULL, array(0 => 'POST', 1 => 'PUT'));

        $j = new \Symfony\Component\Security\Http\AccessMap();
        $j->add($g, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $j->add($h, array(0 => 'ROLE_USER_IP'), 'https');
        $j->add($i, array(0 => 'ROLE_USER_METHOD'), NULL);

        $k = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $l = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $k, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($k, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $l->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($k, array('login_path' => '/', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $m->setProviderKey('secured_area');

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $a, $c), 2 => $l, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $k, 'secured_area', $m, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $k, array('login_path' => '/', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '544f9789f4186', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $j, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $k, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $k, '/', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/www.webwebmaster.fr/http_docs/path/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/www.webwebmaster.fr/http_docs/path/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/var/www/www.webwebmaster.fr/http_docs/path/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/src/Backoffice/MenusBundle/Resources/views', 'BackofficeMenus');
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/src/Backoffice/ContenusBundle/Resources/views', 'BackofficeContenus');
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/vendor/apy/datagrid-bundle/Resources/views', 'APYDataGrid');
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/src/Backoffice/SecurityBundle/Resources/views', 'BackofficeSecurity');
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/app/Resources/views');
        $instance->addPath('/var/www/www.webwebmaster.fr/http_docs/path/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('backoffice yourfaithfully');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/var/www/www.webwebmaster.fr/http_docs/path/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/www.webwebmaster.fr/http_docs/path/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('stephbella', 'd435a93f08fb4b0342f25d1f5522f5352b17449b', array(0 => 'ROLE_ADMIN')));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/www.webwebmaster.fr/http_docs/path/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev',
            'kernel.logs_dir' => '/var/www/www.webwebmaster.fr/http_docs/path/app/logs',
            'kernel.bundles' => array(
                ...
                'BackofficeMenusBundle' => 'Backoffice\\MenusBundle\\BackofficeMenusBundle',
                'BackofficeContenusBundle' => 'Backoffice\\ContenusBundle\\BackofficeContenusBundle',
                'APYDataGridBundle' => 'APY\\DataGridBundle\\APYDataGridBundle',
                'BackofficeSecurityBundle' => 'Backoffice\\SecurityBundle\\BackofficeSecurityBundle',
            ...
            'database_user' => 'root',
            'database_password' => 'bg27tzp9e',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'fr',
            'secret' => 'backoffice yourfaithfully',
            'debug_toolbar' => true,
            ...
            'debug.container.dump' => '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'debug.debug_handlers_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\DebugHandlersListener',
            'kernel.secret' => 'backoffice yourfaithfully',
            ...
            'session.save_path' => '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/profiler',
            ...
            'router.resource' => '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/www.webwebmaster.fr/http_docs/path/app/../web',
            'assetic.write_to' => '/var/www/www.webwebmaster.fr/http_docs/path/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/www.webwebmaster.fr/http_docs/path/app/cache/dev/doctrine/orm/Proxies',
